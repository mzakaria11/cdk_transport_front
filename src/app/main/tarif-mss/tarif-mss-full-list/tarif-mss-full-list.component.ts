...
@Component({
  selector: 'app-tarif-mss-full-list',
  templateUrl: './tarif-mss-full-list.component.html',
  styleUrls: ['./tarif-mss-full-list.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class TarifMssFullListComponent  {
